	...
	class TGM_Plugin_Activation {
		...
		public function init() {
			...
			$this->strings = array(
				...
				'notice_can_install_required'     => _n_noop(
					...
					'WPFacturaOne requires the following plugin: %1$s.',
					'WPFacturaOne requires the following plugins: %1$s.',
					'tgmpa'
				),
				'notice_can_install_recommended'  => _n_noop(
					/* translators: 1: plugin name(s). */
					'WPFacturaOne recommends the following plugin: %1$s.',
					'WPFacturaOne recommends the following plugins: %1$s.',
					'tgmpa'
				),
				'notice_ask_to_update'            => _n_noop(
					/* translators: 1: plugin name(s). */
					'The following plugin needs to be updated to its latest version to ensure maximum compatibility with WPFacturaOne: %1$s.',
					'The following plugins need to be updated to their latest version to ensure maximum compatibility with WPFacturaOne: %1$s.',
					'tgmpa'
				),
				...
				/* translators: 1: plugin name. */
				'plugin_needs_higher_version'     => __( 'Plugin not activated. A higher version of %s is needed for WPFacturaOne. Please update the plugin.', 'tgmpa' ),
		...
		public function filter_plugin_action_links_update( $actions ) {
			$actions['update'] = sprintf(
				...
				esc_attr__( 'WPFacturaOne needs to be updated to be compatible with your theme.', 'tgmpa' ),
